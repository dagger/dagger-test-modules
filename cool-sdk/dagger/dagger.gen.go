...
func (r CoolSdk) MarshalJSON() ([]byte, error) {
	var concrete struct{}
...
func invoke(ctx context.Context, parentJSON []byte, parentName string, fnName string, inputArgs map[string][]byte) (_ any, err error) {
	...
	case "CoolSdk":
		...
		case "ModuleRuntime":
			...
			return (*CoolSdk).ModuleRuntime(&parent, modSource, introspectionJson), nil
		case "Codegen":
			var parent CoolSdk
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
			...
			return (*CoolSdk).Codegen(&parent, modSource, introspectionJson), nil
		case "RequiredPaths":
			var parent CoolSdk
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
			...
			return (*CoolSdk).RequiredPaths(&parent), nil
		default:
